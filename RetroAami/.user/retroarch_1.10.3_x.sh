...
export DEFAULT=/mnt/RetroAami/.user/.config/retroarch/default_configs/ret1103x.cfg
/mnt/RetroAami/.user/retroarch_1.10.3_xtreme -c /mnt/RetroAami/.user/.config/retroarch/ret1103x.cfg
